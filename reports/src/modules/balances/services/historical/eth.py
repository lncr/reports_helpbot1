"""
1. get target block
2. get transactions from genesis to target
3. get transactions from target block to now
4. count sum from genesis to target and from now to target
5. compare sum_from_genesis and (current_balance - sum_from_now)
"""
